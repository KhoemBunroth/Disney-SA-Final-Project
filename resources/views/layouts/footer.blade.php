            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget widget-about">
                        ...
                        <img src={{ asset('images/branding/logos/logo-disney-white.png') }} alt="white logo" class="logo-white">
                        <p class="nomargin">Disney is a ticket reservation system designed for
                            cinemas. It features a great number of features, from normal ticket reservation to
                            multi-user roles. We hope you like it.</p>
                    </div>
                </div>
                <!-- End of Widget 1 -->
